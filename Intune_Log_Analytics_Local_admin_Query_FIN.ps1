...
$CustomerId = "xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx"  

# REPLACE WITH YOUR PRIMARY KEY
$SharedKey = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"

#Control if you want to collect App, Device and/or Local admin Inventory or both (True = Collect)
...
if ($collectAdminInventory) {
    ...
    $localAdministrators = @()
    $administratorsGroup = ([System.Security.Principal.SecurityIdentifier]'S-1-5-32-544').Translate( [System.Security.Principal.NTAccount]).Value
